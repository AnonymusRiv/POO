...
int main(){
    ...
    while(opcion!=10){                                                                      //hacemos un bucle con las distintas posibilidades que podemos hacer en el sistema que se ejecutará siempre y cuando no se introduzca un 10 que es la opción para salir del programa
        ...
        switch(opcion){                                                                       //creamos un switch con todas las opciones disponibles que podemos hacer
            ...
            case 10:                                                                          //en caso de que valga 10, el programa finaliza
