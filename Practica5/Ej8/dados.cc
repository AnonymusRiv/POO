...
void Dados::insertador(){                                   //*función para imprimir el valor de ambos valores*/
    cout<<"El valor del dado 1 es: "<<d1_<<endl;;               //imprimimos el valor del dado 1
    cout<<"El valor del dado 2 es: "<<d2_<<endl;;               //imprimimos el valor del dado 2
}

void Dados::extractor(){                                    //*función para introducir el valor de ambos dados*/
    int valor;                                                  //creamos una variable para almacenar el valor introducido
    cout<<"Introduzca un valor para el dado 1: ";
    cin>>valor;                                                 //introducimos el valor del dado 1
    while(setDado1(valor)!=true){                               //si no se puede asignar dicho valor, se pide el número de nuevo hasta que se introduzca un número correcto
        cout<<"Valor incorrecto"<<endl;
        cout<<"Introduzca un nuevo valor para el dado 1: ";
        cin>>valor;                                             //tendremos que introducir un número correcto
    }
    cout<<"Valor asignado correctamente al dado 1"<<endl;       //se ha asignado correctamente dicho valor introducido

    cout<<endl;
    cout<<"Introduzca un valor para el dado 2: ";
    cin>>valor;                                                 //introducimos el valor del dado 2
    while(setDado2(valor)!=true){                               //si no se puede asignar dicho valor, se pide el número de nuevo hasta que se introduzca un número correcto
        cout<<"Valor incorrecto"<<endl;
        cout<<"Introduzca un nuevo valor para el dado 2: ";
        cin>>valor;                                             //tendremos que introducir un número correcto
    }
    cout<<"Valor asignado correctamente al dado 2"<<endl;       //se ha asignado correctamente dicho valor introducido
}