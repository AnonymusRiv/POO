...
class Dados{                                                                //*creamos la clase dados
    ...
    public:                                                                     //!creamos la parte pública de la clase
        ...
        void insertador();                                                      //esta función nos permitirá mostrar el valor de ambos dados
        void extractor();                                                       //esta función nos permitirá introducir el valor de ambos dados
};
